...
from guests.views import GuestListView, GuestMenuFollowUp, test_email, save_the_date_preview, export_guests, \
    invitation, invitation_email_preview, invitation_email_test, rsvp_confirm, dashboard, save_the_dates_send, \
    rsvp_send, new_dashboard, rsvp_all_send
app_name="guests"
urlpatterns = [
    ...
    path('send-rsvps',rsvp_all_send,name='send-rsvps'),
    re_path(r'^followupquestion/(?P<invite_id>[\w-]+)/$',GuestMenuFollowUp,name='followup'),
